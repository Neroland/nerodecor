...
- **Modpacks are allowed and encouraged** — any platform, no need to ask. Use the official files and credit *NeroDecor by Neroland* with links to this page and the [GitHub repository](https://github.com/Neroland/nerodecor). Full terms: [LICENSE](https://github.com/Neroland/nerodecor/blob/main/LICENSE).
...
- 🟢 **[Also on Modrinth](https://modrinth.com/mod/nerodecor)**
